          ...
          <div className="relative z-10 grid gap-5 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-amber-200/10 bg-black/20 px-4 py-3">
                ...
                <p className="mt-1 text-sm font-medium text-white">Em produção</p>
              </div>
            ...
            return (
              ...
              >
                <span className="flex items-center gap-2">
                  <GameGlyph name={filter.icon} variant="plain" className="h-4 w-4" />
                  <span className="text-xs font-semibold uppercase tracking-[0.12em]">{filter.label}</span>
                </span>
                <span className="mt-1 block text-[11px] uppercase tracking-[0.12em] text-slate-500">{filter.description}</span>
              </button>
            );
          })}
        </div>
            ...
            <GlowCard contentClassName="p-4 sm:p-6">
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-[0.9fr_1.1fr]">
                <div className="rounded-xl border border-white/10 bg-black/20 px-4 py-3">
                  ...
                  <p className="mt-1 text-sm font-medium text-white">{selected.category}</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-black/20 px-4 py-3">
                  <p className="text-xs uppercase tracking-[0.14em] text-slate-400">Status</p>
                  <p className={`mt-1 text-sm font-medium ${selected.status === "Prévia visual" ? "text-cyan-100" : "text-amber-100"}`}>{selected.status}</p>
                </div>
              </div>

              <div className="mt-4 rounded-xl border border-cyan-200/10 bg-black/20 px-4 py-4">
                <p className="text-xs uppercase tracking-[0.14em] text-slate-400">Descrição</p>
              ...
              <div className="mt-4 rounded-xl border border-purple-200/10 bg-purple-300/[0.04] px-4 py-4">
                <p className="text-xs uppercase tracking-[0.14em] text-purple-200/80">Observação</p>
                <p className="mt-2 text-sm leading-6 text-slate-300">{selected.detail}</p>
              </div>
