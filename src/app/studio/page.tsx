    ...
    <AnimatedPageWrapper>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
            ...
            <div className="space-y-4 text-sm leading-6 text-slate-300">
              <p>
                ...
                testes se encontram em um produto real.
              </p>
              <p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {philosophy.map((item) => (
            <GlowCard
              key={item.title}
              variant="flat"
              contentClassName="flex min-h-[164px] flex-col"
            >
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {tools.map((tool) => (
            <GlowCard
              key={tool.name}
              variant="flat"
              contentClassName="flex min-h-[154px] flex-col items-center text-center"
            >
      ...
      <SectionContainer withDivider>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <GlowCard
            variant="quiet"
            contentClassName="flex min-h-[170px] flex-col"
          >
