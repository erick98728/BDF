...
function HeroVisual() {
  return (
    <div className="pointer-events-none relative mx-auto mt-10 h-[300px] max-w-[430px] sm:h-[360px] lg:mt-0" aria-hidden="true">
      ...
      <div className="absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-200/12 bg-black/12 shadow-[inset_0_0_42px_rgba(99,221,255,0.06),0_0_60px_rgba(99,221,255,0.07)] sm:h-72 sm:w-72" />
      <div className="absolute left-1/2 top-1/2 h-48 w-48 -translate-x-1/2 -translate-y-1/2 rotate-45 rounded-3xl border border-amber-200/14 bg-amber-300/[0.025]" />
      <div className="absolute left-[14%] top-[12%] h-16 w-16 rounded-full border border-purple-200/10 bg-purple-300/8 blur-[1px]" />
      <div className="absolute bottom-[12%] right-[8%] h-20 w-20 rounded-full border border-cyan-200/10 bg-cyan-300/7 blur-[1px]" />
      <div className="absolute left-[10%] right-[12%] top-[54%] h-12 rotate-[-8deg] bg-gradient-to-r from-transparent via-cyan-200/14 to-transparent blur-2xl" />
      <div className="absolute left-[18%] right-[8%] top-[64%] h-10 rotate-[6deg] bg-gradient-to-r from-transparent via-purple-300/13 to-transparent blur-2xl" />
      <ForestSigil className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-82" />
      <div className="absolute left-[10%] top-[66%] rounded-2xl border border-cyan-200/12 bg-[#050914]/60 px-3 py-2 shadow-[0_0_22px_rgba(99,221,255,0.1)] backdrop-blur-md">
        <GameGlyph name="map" variant="plain" className="h-6 w-6 text-cyan-100" />
      </div>
      <div className="absolute right-[11%] top-[18%] rounded-2xl border border-amber-200/12 bg-[#050914]/60 px-3 py-2 shadow-[0_0_22px_rgba(209,168,93,0.1)] backdrop-blur-md">
        <GameGlyph name="ruin" variant="plain" className="h-6 w-6 text-amber-100" />
      </div>
      <div className="absolute bottom-[9%] left-[42%] rounded-2xl border border-purple-200/12 bg-[#050914]/60 px-3 py-2 shadow-[0_0_22px_rgba(168,85,247,0.11)] backdrop-blur-md">
...
export function HeroSection() {
  return (
    <section className="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden py-16 sm:py-20 md:py-24 lg:py-28">
      ...
      <div className="absolute left-[-8rem] top-12 hidden h-72 w-72 rounded-full bg-purple-400/8 blur-3xl md:block" />
      <div className="absolute right-[-8rem] top-0 hidden h-80 w-80 rounded-full bg-cyan-300/8 blur-3xl md:block" />
      <div className="absolute bottom-14 right-[8vw] hidden h-28 w-72 rotate-[-10deg] bg-gradient-to-r from-transparent via-amber-200/8 to-transparent blur-2xl lg:block" />
