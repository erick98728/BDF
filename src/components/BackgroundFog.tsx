export function BackgroundFog() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      ...
      <div className="fog-orb left-[6%] top-[16%] h-56 w-56" />
      <div className="fog-orb right-[-3%] top-[34%] h-80 w-80 bg-[radial-gradient(circle,rgba(209,168,93,0.10),transparent_62%)]" />
      <div className="fog-orb bottom-[8%] left-[32%] h-72 w-72 bg-[radial-gradient(circle,rgba(88,51,140,0.18),transparent_62%)]" />
      <div className="absolute left-[-10%] right-[-10%] top-20 h-28 rotate-[-4deg] bg-gradient-to-r from-transparent via-cyan-200/10 to-transparent blur-2xl" />
      <div className="absolute left-[-8%] right-[-8%] top-[42%] h-20 rotate-[2deg] bg-gradient-to-r from-transparent via-purple-300/9 to-transparent blur-xl" />
      <div className="absolute left-[-12%] right-[-12%] bottom-24 h-32 rotate-[5deg] bg-gradient-to-r from-transparent via-emerald-400/10 to-transparent blur-2xl" />
